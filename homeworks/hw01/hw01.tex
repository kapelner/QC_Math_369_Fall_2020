...
\intermediatesubproblem{If the DGP is $\Xoneton \iid$ with distribution unknown but there is a finite mean  and finite variance, find the risk under squared error loss for $\thetahat = \Xbar$.}\spc{3}
