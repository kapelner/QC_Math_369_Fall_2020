...
\item Asymptotical normality and efficiency of MLE's, delta method
...
\item Fisher's $p$-value
\item Power
\item uniformly most powerful tests?, equivalence testing?
\item Wald test, score test, likelihood ratio and generalized likelihood ratio tests
